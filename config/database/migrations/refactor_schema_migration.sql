...
-- This migration applies the refactored schema with proper normalization
...
-- Create refactored tables following specification hierarchy
...
-- Insert sample data following the new structure
INSERT INTO departments (name, code, description, academic_year, duration_years, semester_count, current_semester, is_active) VALUES
('Computer Science and Engineering', 'CSE', 'Department of Computer Science and Engineering', '2024-25', 4, 8, 1, true),
('Electronics and Communication Engineering', 'ECE', 'Department of Electronics and Communication Engineering', '2024-25', 4, 8, 1, true);

INSERT INTO users (username, email, full_name, hashed_password, role, is_active, student_id, employee_id) VALUES
('admin', 'admin@lms.edu', 'System Administrator', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/8KzKz2', 'admin', true, NULL, 'ADM001'),
('hod_cse', 'hod.cse@lms.edu', 'HOD CSE', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/8KzKz2', 'hod', true, NULL, 'HOD001'),
('teacher1', 'teacher1@lms.edu', 'John Smith', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/8KzKz2', 'teacher', true, NULL, 'TCH001'),
('student1', 'student1@lms.edu', 'Alice Johnson', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/8KzKz2', 'student', true, 'STU001', NULL);

-- Update departments with HOD
UPDATE departments SET hod_id = 2 WHERE id = 1;

INSERT INTO semesters (department_id, semester_number, academic_year, name, start_date, end_date, is_active, is_completed) VALUES
(1, 1, '2024-25', 'Semester 1', '2024-07-01', '2024-12-31', true, false),
(1, 2, '2024-25', 'Semester 2', '2025-01-01', '2025-06-30', false, false);

INSERT INTO classes (name, year, section, semester_id, department_id, class_teacher_id, max_students, description, is_active) VALUES
('Year 1 A', 1, 'A', 1, 1, 3, 30, 'First Year Section A', true),
('Year 1 B', 1, 'B', 1, 1, 3, 30, 'First Year Section B', true);

INSERT INTO subjects (name, code, description, credits, theory_marks, practical_marks, department_id, semester_id, is_active) VALUES
('Data Structures and Algorithms', 'CSE201', 'Data Structures and Algorithms for CSE', 4, 100, 50, 1, 1, true),
('Database Management Systems', 'CSE202', 'Database Management Systems for CSE', 4, 100, 50, 1, 1, true);

INSERT INTO teacher_subjects (teacher_id, subject_id, class_id, is_primary) VALUES
(3, 1, 1, true),
(3, 2, 1, true);

INSERT INTO student_semester_enrollments (student_id, semester_id, class_id, status, enrollment_date) VALUES
(4, 1, 1, 'active', NOW());

INSERT INTO exams (title, description, subject_id, class_id, semester_id, exam_type, status, total_marks, duration_minutes, exam_date, start_time, end_time, created_by) VALUES
('DSA Mid Term', 'Mid Term Exam for Data Structures', 1, 1, 1, 'internal', 'completed', 150, 180, '2024-01-15', '2024-01-15 09:00:00', '2024-01-15 12:00:00', 3),
('DBMS Mid Term', 'Mid Term Exam for Database Management', 2, 1, 1, 'internal', 'completed', 150, 180, '2024-01-20', '2024-01-20 09:00:00', '2024-01-20 12:00:00', 3);

INSERT INTO exam_sections (exam_id, name, instructions, total_marks, total_questions, questions_to_attempt, section_type, optional_questions, mandatory_questions, question_marks) VALUES
(1, 'Section A', 'Answer all questions', 50, 5, 5, 'standard', 0, 5, 10.0),
(1, 'Section B', 'Answer any 3 out of 5', 100, 5, 3, 'optional', 2, 3, 20.0),
(2, 'Section A', 'Answer all questions', 75, 3, 3, 'standard', 0, 3, 25.0),
(2, 'Section B', 'Answer any 2 out of 3', 75, 3, 2, 'optional', 1, 2, 25.0);

INSERT INTO questions (question_text, marks, difficulty_level, bloom_level, section_id, question_number, order_index, is_optional, created_by) VALUES
('What is a binary tree?', 10, 'easy', 'remember', 1, '1', 1, false, 3),
('Explain time complexity of quicksort', 10, 'medium', 'understand', 1, '2', 2, false, 3),
('Implement a stack using arrays', 20, 'hard', 'apply', 2, '3', 1, false, 3),
('What is normalization?', 25, 'medium', 'understand', 3, '1', 1, false, 3),
('Write SQL query to find top 5 students', 25, 'hard', 'apply', 3, '2', 2, false, 3);

INSERT INTO marks (student_id, exam_id, question_id, marks_obtained, max_marks, is_attempted, attempt_number, is_best_attempt, is_counted_for_total, bloom_level, difficulty_level, graded_by, graded_at) VALUES
(4, 1, 1, 9, 10, true, 1, true, true, 'remember', 'easy', 3, NOW()),
(4, 1, 2, 8, 10, true, 1, true, true, 'understand', 'medium', 3, NOW()),
(4, 1, 3, 18, 20, true, 1, true, true, 'apply', 'hard', 3, NOW()),
(4, 2, 4, 22, 25, true, 1, true, true, 'understand', 'medium', 3, NOW()),
(4, 2, 5, 23, 25, true, 1, true, true, 'apply', 'hard', 3, NOW());

INSERT INTO cos (name, description, subject_id, department_id) VALUES
('CO1', 'Understand basic data structures', 1, 1),
('CO2', 'Apply algorithms to solve problems', 1, 1),
('CO3', 'Analyze time and space complexity', 1, 1),
('CO4', 'Design efficient data structures', 2, 1),
('CO5', 'Implement database systems', 2, 1);
...
('PO4', 'Conduct investigations: Use research-based knowledge and research methods', 1);
